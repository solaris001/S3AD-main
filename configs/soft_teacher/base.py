...
data = dict(
    ...
    val=dict(
        ann_file='data/MAD_tiles/annotations/instances_val.json',
        img_prefix='data/MAD_tiles/val/',
        pipeline=test_pipeline,
        filter_empty_gt=False
    ),
    test=dict(
        ann_file='data/MAD_tiles/annotations/instances_test.json',
        img_prefix='data/MAD_tiles/val/',
        pipeline=test_pipeline
    ),
    sampler=dict(
...
evaluation = dict(type="SubModulesDistEvalHook", interval=500)
optimizer = dict(type="SGD", lr=0.01, momentum=0.9, weight_decay=0.0001)
lr_config = dict(step=[60000, 80000])
#lr_config = dict(step=[80000, 120000])
